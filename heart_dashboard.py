...
def load_data():
    ...
    return df.dropna(subset=["Sex","Age","Residence","Smoker_Num","HTN_Num","Bleeding_Num","Year"])
...
with r1c1:
    ...
    fig1.update_layout(dragmode="select", height=260, margin=dict(t=30,b=10,l=10,r=10))
